...
class com_SimplifiedSocialShareInstallerScript
{
    ...
    /**
     * function is used to install extension after unzip file
     * 
     * @param $type
     * @param $parent
     * @return bool
    ...
    /**
     * update extension is old extension exist
     * 
     * @param $type
     */
    ...
    /**
     * show html table after success inatallation
     * @param $status
     */
    private function installationResults($status)
    {
        ...
        if (count($status->plugins))
        {
            ...
            <?php echo JText::_('COM_SOCIAL_SHARE_INSTALLATION_FREE'); ?>
                <a href="https://www.social9.com/contact" target="_blank">
